...
(defun patrl/setup-font-vivacia ()
  (set-face-attribute 'default nil :font (font-spec :family "IBM Plex Mono" :size 18 :weight 'medium))
  (set-face-attribute 'fixed-pitch nil :font (font-spec :family "IBM Plex Mono" :size 18 :weight 'medium)))
