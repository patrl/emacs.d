...
*** Issues
**** DONE fix citar in org-mode
**** TODO something is preventing ~prettify-symbols-mode~ from working correctly in any mode, ~org-toggle-pretty-entities~ works fine however.
