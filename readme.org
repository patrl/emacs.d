...
** TODO get search working with [[PDF tools]]
See the following issue, which is probably related: [[https://github.com/politza/pdf-tools/issues/528][politza/pdf-tools#528 What would be the correct `use-package` declaration?]] 
...
#+begin_src emacs-lisp :tangle init.el
  (use-package org-roam
    ...
    (setq org-roam-database-connector 'sqlite-builtin) ;; depends on emacs version 29
