...
- [[https://github.com/progfolio/elpaca?tab=readme-ov-file#installer][Bootstrap instructions]] 
...
I'm currently using ~firefox-beta~, so I need to make sure that the built-in ~browse-url~ package knows about this. 
...
- [[http://www.yummymelon.com/devnull/using-ediff-in-2023.html][nfdn: Using Ediff in 2023]] 
...
- [[https://git.sr.ht/~technomancy/fennel-mode][fennel-mode]] — a Lisp that compiles to Lua.
...
- [[https://github.com/minad/cape][GitHub - minad/cape: 🦸cape.el - Completion At Point Extensions]]
